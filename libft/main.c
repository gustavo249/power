...
/*   Updated: 2015/11/10 16:23:33 by rcrisan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	test_atoi(void)
{
    ...
    ctrl[4] = atoi("1230978Ã©bpo");
    ctrl[5] = atoi("1230978bÃ©po");
    ...
    test[4] = ft_atoi("1230978Ã©bpo");
    test[5] = ft_atoi("1230978bÃ©po");
...
int			main(void)
{
    ...
    printf(YELLOW"disagreed"UNCOLOR" signifie que la fonction ne s'est pas comportÃ©e comme prÃ©vu, mais que cela n'est pas forcÃ©ment un fail (c'est Ã  vous de dÃ©cider). RÃ©fÃ©rez vous aux commentaires dans le code pour plus de dÃ©tails.\n");
    ...
    printf(RED"ATTENTION:"UNCOLOR" Si vous utilisez ce test pour corriger un autre Ã©lÃ¨ve, __s'il_vous_plait__ vÃ©rifiez le code des tests qui ont Ã©chouÃ© avant de la/le saquer, et essayerz de comprendre d'oÃ¹ vient le problÃ¨me. J'ai pu faire une erreur, ou ses fonctions pourraient avoir un comportement diffÃ©rent des miennes, tout en restant en accord avec les instructions (ceci est valable principalement pour les fonctions supplÃ©mentaires). Ce programme n'est pas lÃ  pour faire la correction Ã  votre place.\n");
    return (0);
}
